/**
 * 測試所有功能功，包含偵測日期格式是否正確並將格式統一轉成字串、判斷日期的關係，以及計算日期間相差的天數。
 *
 * @author 			熊亮茵
 * @ID 				B11505064
...
#include "Date.h"
  ...
  int main() {
    ...
    cout << "\nTest if year 2000 is leap year:" << d1->isLeapYear(2000);
    cout << "\nTest if year 1996 is leap year:" << d1->isLeapYear(1996);
    cout << "\nTest if year 2023 is leap year:" << d1->isLeapYear(2023);
